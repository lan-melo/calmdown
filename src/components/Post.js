    ...
    return (
        <>
            ...
            <View style={styles.container}>
                ...
                <Modal visible={modalOpenMessage} animationType='slide'>
                    <Icon name={'close'} size={40}
                        iconStyle={{ color: '#6490D2', left: 0, right: 0, top: 10 }}
                        onPress={() => setModalOpenMessage(false)} />
                    <View>
                        <InsertMessage addMessage={addMessage} />
                    </View>
                </Modal>
                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity style={styles.postContainer}>
                            ...
                            <View style={styles.postResponse}>
                                <TouchableOpacity onPress={() => setModalOpenMessage(true)}>
